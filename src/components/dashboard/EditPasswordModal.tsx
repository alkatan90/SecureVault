...
export default function EditPasswordModal({ password, onClose }: EditPasswordModalProps) {
  ...
  const { updatePassword, categories, generateSecurePassword, checkPasswordStrength } = usePasswords();
      ...
      <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center">
            ...
            />
            <label htmlFor="favorite-edit" className="ml-2 text-sm text-gray-300">
              Add to favorites
            </label>
          </div>
